...
```{r read data from first source, echo=FALSE, message=FALSE}
...
```{r read data from second source, echo=FALSE, message=FALSE}
...
```{r read data from each state, echo=FALSE, message=FALSE}
...
```{r change state information to a table, echo=FALSE, message=FALSE}
library(reshape2)
...
```{r diversity_school wrangling and analysis, echo=FALSE, message=FALSE}
t1 <- diversity_school %>%
  drop_na() %>%
...
```{r historical_tuition analysis, echo=FALSE, message=FALSE}
grid.arrange(
  historical_tuition %>% 
...
```{r salary_potential analysis, echo=FALSE, message=FALSE}
t2 <- salary_potential %>% 
  drop_na() %>%
  group_by(state_name) %>%
...
```{r tuition_cost analysis, echo=FALSE, message=FALSE}
...
```{r tuition_cost + diversity_school, echo=FALSE, message=FALSE}
...
```{r 2020 tuition cost data cleaning, echo=FALSE, message=FALSE}
...
```{r data analysis with the second data source,echo=FALSE, message=FALSE}
scraped <- scraped %>%
  .[-62,] %>%
